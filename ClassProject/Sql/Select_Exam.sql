...
SELECT ename, sal, sal*12 as yearSal, sal*12+100 as totalSal
...
SELECT ename, hiredate from emp where hiredate like '81/__/__';

-- 10. 관리자가 없는 사원의 이름과 담당 업무를 출력하시오.
SELECT ename, job, mgr from emp where mgr is null;

-- 11. 커미션을 받을 수 있는 자격이 되는 사원의 이름, 급여, 커미션을 출력하되 급여 및 커미션을 
