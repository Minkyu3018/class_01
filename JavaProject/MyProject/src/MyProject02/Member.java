...
//	  라고 출력하도록 합니다.
	...
	static void printCheckFreeVaccine(int year) {
		...
		int age = 2023 - year + 1;  // 현재나이 계산
		
		if(age < 15 || age >= 65) {
			System.out.println("무료 예방접종이 가능합니다.");
		} else {
			System.out.println("무료 접종 대상이 아닙니다.ㅠㅠ");
		}
	}
...
//	- 40 이상의 경우는 암 검사도 무료로 검사를 할 수 있습니다.
	...
	static void printCheckFreeMedical(int year) {
		...
		if ( age >= 20 && (2023+year)%2 == 0 ) {
			...
			if (age > 40) {
				...
				System.out.println("올해는 무료 암검진 대상자가 아닙니다.");
			}
		}
