...
public class DeptListController {
    ...
    public void getListPage(
        ...
        deptSearchOption.setKeyword(
                deptSearchOption.getKeyword()!=null && deptSearchOption.getKeyword()
                        .trim()
                        .length() > 0 ? deptSearchOption.getKeyword() : null
        );

        searchOption.setSearchType(
                deptSearchOption.getKeyword()!=null && deptSearchOption.getKeyword()
                        .trim()
                        .length() > 0 ? deptSearchOption.getSearchType() : null
        );
