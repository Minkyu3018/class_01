-- 수업 복습 function_exam1

-- 16. SUBSTR 함수를 사용하여 사원들의 입사한 년도와 입사한 달만 출력하시오.
select ename, 
substr(hiredate,1,5) as "입사 년,월"
from emp;
...
-- 19. 입사일을 년도는 2자리(YY), 월은 숫자(MM)로 표시하고 요일은 
-- 약어 (DY)로 지정하여 출력하시오.
...
-- 21. 사원들의 상관 사번을 출력하되 상관이 없는 사원에 대해서는 
-- NULL 값 대신 0으로 출력하시오.
...
select job,
max(sal), min(sal), sum(sal), round(avg(sal))
from emp
group by job;
