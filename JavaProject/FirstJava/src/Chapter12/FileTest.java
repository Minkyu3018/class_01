...
public class FileTest {
	...
	public static void main(String[] args) {
		...
		if(!dir1.exists()) {
			...
			dir1.mkdir(); // 디렉터리를 만든다
			System.out.println("d:\\tests 폴더를 생성...");
		}
		
		if(file1.exists()) {
			System.out.println("파일이 존재합니다");
		} else {
			System.out.println("파일이 존재하지 않아 프로그램 종료.");
		}
		
		
		File dir2 = new File("d:\\test");
		
		File newFile = new File("d:\\test", "test-text.txt");
		...
		File newPathFile = new File("d:\\Test\\abc", "test-text2.txt");
