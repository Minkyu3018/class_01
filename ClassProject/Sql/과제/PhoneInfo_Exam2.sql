...
insert into phoneInfo_basic values (seq_pbasic_idx.nextval ,'손흥민' ,'010-1234-5678' ,'son@gmail.com' ,'서울' ,'20/05/05' ) ;
...
insert into phoneInfo_univ values (seq_puniv_idx.nextval ,'축구 ' ,4, seq_pbasic_idx.currval);
...
insert into phoneInfo_com values (seq_pcom_idx.nextval, 'AA', seq_pbasic_idx.currval);
